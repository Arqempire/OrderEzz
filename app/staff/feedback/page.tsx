...
export default function StaffFeedbackPage() {
  ...
  return (
    <main className="staff-dashboard-container space-y-8">
      {/* Header Navigation */}
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-extrabold font-display text-slate-100">
              Staff Customer Feedback & Reviews
            </h1>
            <p className="text-xs text-slate-400 mt-0.5">
              Review diner ratings, experience tags, and chef compliments submitted at table checkout
            </p>
          </div>
        </div>
