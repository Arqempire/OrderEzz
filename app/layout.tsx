  ...
  return (
    <html lang="en" className={`${inter.variable} ${outfit.variable}`}>
      <body className="bg-slate-950 text-slate-100 antialiased selection:bg-amber-500 selection:text-slate-950 flex flex-col min-h-screen">
        ...
        <footer className="py-3 px-4 text-center text-[11px] font-medium text-slate-400/70 select-none bg-slate-950 border-t border-slate-900/60 relative z-0 no-print print:hidden">
